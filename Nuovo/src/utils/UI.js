...
export const getContentColSpan = (selectedPage) => {
    const lgColSpan = selectedPage?.anchors?.length ? "lg:col-span-6 xl:col-span-8" : "lg:col-span-10 lg:pr-20";
...
export const getSidebarColSpan = () => {
    return "hidden lg:block lg:col-span-3 xl:col-span-2 text-center sticky top-0 h-screen min-h-screen overflow-y-scroll hide-scrollbar";
};
